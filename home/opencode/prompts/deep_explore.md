...
7. Read the nearby `AGENTS.md` before investigating a directory.
8. If `.agents/architecture-diff.md` exists, read it and prioritize the changed files, recent commits, and working-tree changes shown there.
...
- `.agents/architecture-diff.md` is an automatically generated, read-only change-detection file; do not edit it.
</Rules>
